...
public class ExcelUtil {
    ...
    public ExcelUtil(String filePath, int indexOfSheet) throws Exception {
    ...
    public ExcelUtil(String filePath, int indexOfSheet, int indexOfRow, String id) throws Exception {
        this.indexOfSheet = indexOfSheet;
        this.filePath = filePath;
        this.id = id;
        LoadOptions loadOptions = new LoadOptions(FileFormatType.XLSX);
    ...
    public ArrayList<Customer> getCustomers(ArrayList<Integer> arr) {
