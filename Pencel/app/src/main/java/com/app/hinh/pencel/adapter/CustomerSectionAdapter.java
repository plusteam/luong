...
import com.app.hinh.pencel.ui.CustomerActivity;

public class CustomerSectionAdapter extends BaseAdapter implements SectionIndexer {
    private ArrayList<String> stringArray;
    private Context context;
    public CustomerSectionAdapter(Context _context, ArrayList<String> arr) {
        stringArray = arr;
        context = _context;
    }
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        View view = (View) inflate.inflate(R.layout.item_customer_section, null);
    ...
    private void setSection(LinearLayout header, String label) {
        ...
        header.setBackgroundResource(R.color.colorGreen);
        text.setTextColor(Color.WHITE);
        text.setText(label.substring(0, 1).toUpperCase());
        text.setTextSize(25);
        text.setPadding(16, 10, 10, 10);
