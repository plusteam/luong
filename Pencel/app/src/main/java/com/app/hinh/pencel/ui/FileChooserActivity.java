...
public class FileChooserActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPath = (TextView)findViewById(R.id.txtChooseFile);
    }
    ...
    public void showDialog() {
        ...
        dialogUtil.setHeaderIcon(R.drawable.ic_folder);
        ...
        dialogUtil.getBtnNext().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i != -1) {
                    ...
                    txtPath.setText( dialogUtil.getArrView().get(i).getLine1());
                    dialogUtil.getDialog().dismiss();
                } else {
    ...
    public void loadListFile(File file) {
        ...
        for (File f : files) {
            ...
            dialogUtil.getArrView().add(new CustomListview(fileName, filePath, false, null, type));
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btnShowDialog:
                ...
                break;
            case R.id.btnCancel:
                it = new Intent(FileChooserActivity.this, MainActivity.class);
                startActivity(it);
                break;
            case R.id.btnNext:
                if (!filePath.equals("")) {
                    it = new Intent(this, SheetChooserActivity.class);
