...
public class CustomCalendar extends LinearLayout {
    ...
    private TableLayout setupNotification;
    ...
    private void initViews() {
        ...
        mViewPager.animate().x(0).y(0).setDuration(500).start();
        ...
        addNotification=(Button)findViewById(R.id.addNotifination);
        setupNotification=(TableLayout)findViewById(R.id.setupNotification);
        ...
        addNotification.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (setupNotification.getVisibility()==GONE){
                    setupNotification.setVisibility(VISIBLE);
                }
                else{
                    setupNotification.setVisibility(GONE);
